...
class LandingActivity : BaseActivity(), LandingMvpView {
    ...
    private fun setupMenu() {
        ...
        mSettingsCard.background = ContextCompat.getDrawable(this, R.drawable.landing_settings_card_fill)
    ...
    override fun showErrorMessage(code: Int) {
        when (code) {
            NetworkUtil.HTTP_NOT_FOUND -> showAlert(R.string.internet_connection_error_title, R.string.internet_not_found_content)
    ...
    override fun showOfflineMessage() {
        val snackbar = Snackbar.make(parentView, R.string.internet_not_available, Snackbar.LENGTH_INDEFINITE)

...
class AlarmReciever : BroadcastReceiver() {
    ...
    override fun onReceive(context: Context, intent: Intent) {
        ...
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.O) {
            ...
            mBuilder = mNotificationUtils.getAndroidChannelNotification(context.getString(R.string.notification_review_title),
            ...
            val mBuilder = NotificationCompat.Builder(context).setSmallIcon(
                    ...
                    .setContentText(context.getString(R.string.notification_review_content)) as NotificationCompat.Builder
